...
/**
 * "Continue with Google" — triggers NextAuth Google OAuth flow.
 * Redirects to /onboarding after successful sign-in.
 */
  ...
  return (
    <motion.button
      ...
      className={[
        ...
        "border border-white/20 bg-white/95 px-6 py-3.5",
